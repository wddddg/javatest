...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public PageResult queryOrder(@RequestBody OrdersPageQueryDTO ordersPageQueryDTO) {
    ...
    @Override
    public PageResult queryOrderByUser(int page, int pageSize, Integer status) {
        PageHelper.startPage(page, pageSize);

        OrdersPageQueryDTO ordersPageQueryDTO = new OrdersPageQueryDTO();
        ordersPageQueryDTO.setUserId(BaseContext.getCurrentId());
        ordersPageQueryDTO.setStatus(status);
        Page<Orders> pageList = orderMapper.queryOrder(ordersPageQueryDTO);
